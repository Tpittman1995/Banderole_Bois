...
Serial::Serial(const char portName[]) {
    ...
    // Set termios struc, we call it 'tty' for convention
    ...
    // Set up message structure and format
...
// Deconstructor - closes serial port
Serial::~Serial() {
     close(serial_port);
}

void Serial::writeData(uint8_t msg[], int length){
...
void Serial::readData(uint8_t *read_buf){
    ...
    int num_bytes = read(serial_port, read_buf, 4096); //sizeof(read_buf)
...
//    int serial_port = open("/dev/ttyACM0", O_RDWR); //USB0
